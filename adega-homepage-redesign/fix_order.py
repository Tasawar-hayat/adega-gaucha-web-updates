...
<!-- ADEGA GAUCHA - ONLINE ORDER SECTION (FIXED ANIMATIONS) -->
<div id="adega-online-order" class="adegagaucha-section">
  ...
  <div class="order-container">
    ...
    <div class="order-content">
      <span class="order-badge">Online Ordering</span>
      <h2 class="order-title">Bring The <span>Adega</span> Experience Home</h2>
      <p class="order-desc">
